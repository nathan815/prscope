...
describe('computeReviewThoroughness', () => {
  it('returns 0 when no PRs analyzed', () => {
    expect(computeReviewThoroughness({
      avgCommentsPerPr: 0,
  ...
  it('returns score between 1 and 5 inclusive', () => {
    const scenarios = [
      { avgCommentsPerPr: 0, approvalsWithComments: 0, approvalsWithoutComments: 1, waitingForAuthor: 0, rejected: 0, totalPrsAnalyzed: 1 },
      { avgCommentsPerPr: 2, approvalsWithComments: 5, approvalsWithoutComments: 5, waitingForAuthor: 1, rejected: 0, totalPrsAnalyzed: 10 },
      { avgCommentsPerPr: 10, approvalsWithComments: 10, approvalsWithoutComments: 0, waitingForAuthor: 5, rejected: 5, totalPrsAnalyzed: 10 },
    ];
